...
def test_stretched_vertical_bp3_three_steps_match_matlab_reference(tmp_path):
    ...
    MATLAB uses bisection and Python uses safeguarded Newton.  Both terminate at
    a 5 Pa friction-residual tolerance, so slip rates agree to solver tolerance
