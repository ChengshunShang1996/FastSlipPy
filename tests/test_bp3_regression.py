...
def test_bp3_example_grid_matches_expected_stretch_parameters():
...
def test_bp3_surface_bottom_and_side_rows_match_staggered_layout():
    params = _bp3_parameters()
...
def test_stretched_vertical_bp3_three_step_smoke(tmp_path):
    """Exercise the production loop on a compact stretched 90-degree case."""
